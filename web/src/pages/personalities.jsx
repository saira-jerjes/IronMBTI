...
const personalities = ["Pool", "Cristian", "Julio", "Carlos"];
          ...
          return (
            <div key={personality} className="personality-card">
              <div className="personality-image-container">
                <img src={image} alt={personality} className="personality-image" />
              </div>
              <h2 className="personality-title">{title}</h2>
